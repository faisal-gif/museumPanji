    ...
    <div class="container">
      <div class="row d-flex align-items-center justify-content-center">
        <div class="about-content col-lg-12">
          ...
          <p class="text-white link-nav"><a href="index.html">Beranda </a>  <span class="lnr lnr-arrow-right"></span>  <a href="contact.html"> Visi & Misi</a></p>
        </div>											
      </div>
    </div>
  </section> 
					...
					<div class="row">
						<div class="col-lg-13 event-left">
							<div class="single-events">
								<img class="img-fluid" src="{{asset('assets/image/candi2.jpg')}}" alt="">
								<p>
									<br>
